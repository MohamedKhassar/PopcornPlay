...
const Footer = () => {
    return (
        <footer className='bg-blue-950 rounded-t-2xl lg:py-6 py-4 px-10 flex flex-wrap items-center md:justify-between justify-center gap-4 w-full mt-5 sticky top-full'>
